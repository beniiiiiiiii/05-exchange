        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HufAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    AppliedRate = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    CustomerName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CustomerIdType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CustomerIdNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transaction_ExchangeRate_ExchangeRateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExchangeRate_Currency_Date",
                table: "ExchangeRate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaction_ExchangeRateId",
                table: "Transaction",
